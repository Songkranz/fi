local TeleportService, GuiService, plr = game:GetService("TeleportService"), game:GetService("GuiService"), game:GetService("Players").LocalPlayer
...
local rerollStandRow = titledRow(RerollForm, "Auto Reroll Stand","Reroll until a combo matches — waits for respawn if you die")
...
local rerollAttriRow = titledRow(RerollForm, "Auto Reroll Attribute","Trait Orb until it matches 'Select attributes' — out of orbs: rollback + rejoin")
